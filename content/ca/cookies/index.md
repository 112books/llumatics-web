...
Una cookie és un petit fitxer de text que un lloc web emmagatzema al vostre navegador quan el visiteu. Les cookies permeten que el web recordi les vostres preferències o accions durant un temps determinat.
...
Podeu configurar el vostre navegador per bloquejar o eliminar cookies en qualsevol moment:

- **Firefox:** Configuració → Privadesa i seguretat → Cookies i dades del lloc
- **Chrome:** Configuració → Privadesa i seguretat → Cookies i altres dades del lloc
