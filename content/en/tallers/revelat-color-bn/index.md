...
# Pedagogical notes
objective: "Understand how a C-41 colour film reacts when developed with a B&W process, and learn to read and scan the resulting negatives despite their technical difficulty."
methodology: "Complete darkroom process: pre-wash, stand development with Rodinal 1+100 for 60 minutes, stop bath, fix, final wash and a first verification scan of the negatives."
result: "One colour roll developed with a B&W process, negatives with their characteristic cast and 2–3 verification scans of the frames. Practical understanding of the limits and possibilities of the process."
prerequisits: "Recommended to know how to develop B&W film independently. Not essential, but the workshop moves faster if you already know the basic development process."
target: "Analogue photographers curious about chemical experimentation. Anyone who wants to understand why the wrong process can produce interesting results — and why sometimes it won't."
...
tags: ["development", "colour", "C-41", "black and white", "experimental", "Rodinal", "stand development", "cross process"]
date: 2026-04-20
draft: false
---
...
- Full roll scanning (available as an add-on to the [Digitalisation workshop](/en/tallers/digitalitzacio-escaner/) or as a one-to-one session from €20)
