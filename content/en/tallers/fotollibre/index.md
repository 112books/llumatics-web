...
# Pedagogical notes
objective: "Transform a photographic body of work into a coherent, producible editorial object: with concept, narrative, design and files ready for print or digital distribution."
methodology: "Three 4-hour sessions with intermediate tasks between them. Session 1: concept, format and narrative. Task: physical maquette. Session 2: review maquette and digital layout in Affinity Publisher. Task: complete the document. Session 3: final review, exports and print quote."
result: "A complete photobook file (Affinity Publisher), exportable as a print-ready PDF or for digital distribution, ePub or web. A custom print quote via 112books calculated live during session 3."
prerequisits: "A personal photographic body of work: at least 50–100 images from the same project or theme. No previous Llumàtics workshop required."
target: "Photographers with a set of images who want to make the step to a book. The natural next step after the From Street to Book course, but open to any photographer with a project."
...
tags: ["photobook", "editorial", "design", "narrative", "print", "112books", "Affinity Publisher"]
draft: false
---
...
The workshop uses **[Affinity Publisher](https://affinity.serif.com/publisher/)**, available for free since 2024. It needs to be installed before session 2. Llumàtics has its own licence for the studio computers. If you prefer to work with Adobe InDesign and already have a licence, that's also fine.
