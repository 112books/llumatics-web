---
title: "Portrait in Large Format"
layout: "private-doc"
url: "/en/tallers/retrat-gran-format/privat/doc/"
...
Large format photography is made with specialist cameras that produce a negative (or positive) far larger than 35mm or medium format. It begins at 9×12 cm plates, continues through the classic 4×5 inches (10×12.7 cm), 13×18 cm and 20×25 cm, and extends to even larger sizes, often with custom-built cameras.
...
|--------|-----------------|-------------|
| 9×12 cm | 9 × 12 cm | Studio portrait, reportage |
| 4×5" | 10 × 12.7 cm | The most widely used large format today |
| 13×18 cm | 13 × 18 cm | Landscape, architecture |
| 8×10" (20×25 cm) | 20 × 25 cm | Studio, contact printing |
...
| Movement | Effect |
|---------|--------|
| **Tilt** | Tilts the lens or film plane; extends or concentrates depth of field (Scheimpflug Principle) |
| **Swing** | Rotates on the vertical axis; corrects horizontal perspective |
| **Rise / Fall** | Moves the lens up or down without tilting the camera; eliminates converging vertical lines |
| **Shift** | Moves the lens laterally; useful for panoramas and corrections |
...
### 4. Meter the light and calculate the exposure
Use an incident light meter (the recommended choice for large format). Bear in mind:
- The **bellows extension factor**: when the lens is extended far out to focus close, the bellows cuts the light and exposure must be corrected.
- **Reciprocity failure**: for long exposures (>1s), film or paper loses sensitivity and the time must be increased.

### 5. Stop down and cock the shutter
Large format lenses have a built-in leaf shutter (Copal, Compur). Close the aperture to the chosen f-stop, cock the shutter, and attach the cable release.
...
- Large format camera with lens (Schneider, Rodenstock, Fujinon, Nikkor)
- Film holders (minimum 2 per session)
- Robust tripod
- Cable release
- Dark cloth for viewing
- Loupe for the ground glass

**Light-sensitive material**
- Photographic paper (RC or fibre), sheet film, or sensitised glass
...
If you are exposing photographic paper (as we do in this workshop), development takes place under amber or red safelight:
