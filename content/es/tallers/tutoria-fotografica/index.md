...
No todos los aprendizajes funcionan igual. Hay personas que aprenden mejor en grupo, y otras que necesitan un espacio donde no hace falta seguir el ritmo de nadie. La tutoría es para las segundas —y para las primeras, cuando quieren profundizar en algo concreto.
...
- Primera vez en el laboratorio: revelado de película paso a paso
- Revisión y edición de un proyecto fotográfico personal
- Aprender a hacer copias en papel con los propios negativos
- Entender por qué las fotos no salen como se espera
- Explorar una técnica concreta: gran formato, estenopeica, procesos alternativos
- Preparación para un encargo o una exposición
