---
title: "Retrato en gran formato"
layout: "private-doc"
url: "/es/tallers/retrat-gran-format/privat/doc/"
...
## Qué es la fotografía en gran formato

La fotografía en gran formato es la que se realiza con cámaras específicas que producen un negativo (o positivo) de dimensiones muy superiores al formato de 35mm o al medio formato. Se considera gran formato a partir de las placas de 9×12 cm, pasando por el clásico 4×5 pulgadas (10×12,7 cm), 13×18 cm y 20×25 cm, hasta formatos aún mayores, a menudo con cámaras fabricadas a medida.
...
| Formato | Tamaño aproximado | Uso típico |
|---------|------------------|-----------|
| 9×12 cm | 9 × 12 cm | Retrato de estudio, reportaje |
| 4×5" | 10 × 12,7 cm | El formato de gran formato más extendido hoy |
| 13×18 cm | 13 × 18 cm | Paisaje, arquitectura |
| 8×10" (20×25 cm) | 20 × 25 cm | Estudio, copias por contacto |
...
| Movimiento | Efecto |
|-----------|--------|
| **Tilt** (bascular) | Inclina el plano del objetivo o la película; permite extender o concentrar la profundidad de campo (Principio de Scheimpflug) |
| **Swing** (girar) | Gira sobre el eje vertical; corrige perspectiva en horizontal |
| **Rise / Fall** (subir/bajar) | Desplaza el objetivo arriba o abajo sin inclinar la cámara; elimina la convergencia de líneas verticales |
| **Shift** (desplazar lateral) | Mueve lateralmente el objetivo; útil para panorámicas y correcciones |
...
### 4. Medir la luz y calcular la exposición
Utiliza un fotómetro de incidente (el más recomendado para gran formato). Ten en cuenta:
- El **factor de fuelle**: cuando el objetivo se extiende mucho para enfocar cerca, el fuelle corta luz y hay que corregir la exposición.
- La **reciprocidad**: para exposiciones largas (>1s), el papel o la película pierde sensibilidad y hay que incrementar el tiempo.

### 5. Cerrar el diafragma y armar el obturador
El objetivo de gran formato tiene el obturador integrado (Copal, Compur). Cierra el diafragma a la apertura elegida, arma el obturador y conecta el disparador de cable.
...
**Cámara y accesorios**
- Cámara de gran formato con objetivo (Schneider, Rodenstock, Fujinon, Nikkor)
- Chasis de placa (mínimo 2 por sesión)
- Trípode robusto
- Disparador de cable
- Tela negra de composición
- Lupa para el cristal esmerilado

**Material fotosensible**
- Papel fotográfico (RC o fibra), película de placa o vidrio sensibilizado
...
Si se expone papel fotográfico (como hacemos en el taller), el revelado se hace en luz de seguridad ámbar o roja:
